...
function Privacy() {
  return (
    <>
    <Navbar/>
    <section class="pt-10 pb-8 overflow-hidden sm:pt-16 lg:pt-24 mt-[30px]">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Connect with all apps</h2>
            <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Odio vero quia consequatur, excepturi culpa sunt?</p>
            <a
                href="#"
                title=""
