...
function AboutUs() {
  return (
    <>
    <Navbar/>
    <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 mt-[50px]">
                ...
                <div class="w-full lg:w-8/12 lg:pt-8">
                    <div class="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-md">
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            ...
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-black mt-4">Alexa</p>
                        </div>
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            ...
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-black mt-4">Olivia</p>
                        </div>
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            ...
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-black mt-4">Liam</p>
                        </div>
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            ...
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-black mt-4">Elijah</p>
                        </div>
                    </div>
                </div>
            </div>
